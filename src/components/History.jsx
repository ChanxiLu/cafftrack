...
export default function History(){
    ...
    return (
        <>
            ...
            <h6>Total Amount of Coffees: {Object.keys(globalData).length}</h6>
            ...
            <div className="coffee-history">
                {Object.keys(globalData).sort((a, b) => b - a).map((utcTime, coffeeIndex) => {
                    ...
                    const summary = `${coffee.name} | $${coffee.cost}clp | ${timeSinceConsume} | ${remainingAmount}mg / ${originalAmount}mg`
